...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/isohmaohot/autoscript-multiws/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/isohmaohot/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
